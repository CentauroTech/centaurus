...
export const PHASE_DUE_DATE_MAP: Record<string, { field: keyof Task; label: string }> = {
  ...
  'casting': { field: 'voiceTestsDueDate', label: 'Casting Due Date' },
  'voice tests': { field: 'voiceTestsDueDate', label: 'Casting Due Date' },
  'recording': { field: 'recordingDueDate', label: 'Recording Due Date' },
  'qc 1': { field: 'premixDueDate', label: 'QC 1 Due Date' },
  'premix': { field: 'premixDueDate', label: 'QC 1 Due Date' },
...
export const ALL_PHASE_DUE_DATE_FIELDS: { field: keyof Task; label: string; key: string }[] = [
  ...
  { field: 'voiceTestsDueDate', label: 'Casting Due Date', key: 'voice_tests' },
  { field: 'recordingDueDate', label: 'Recording Due Date', key: 'recording' },
  { field: 'premixDueDate', label: 'QC 1 Due Date', key: 'premix' },
...
export const COLUMNS: ColumnConfig[] = [
  ...
  { id: 'estudioRevisado', label: 'Estudio Revisado', type: 'dropdown', width: 'w-32', field: 'estudioRevisado', options: ['On Hold', 'Working On It', 'Done'] },
...
export const COLUMNS_COLOMBIA: ColumnConfig[] = COLUMNS;
